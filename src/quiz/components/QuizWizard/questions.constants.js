const questions = [
  ...
  {
    id: "scalp",
    question: "If you shampoo in the morning, how does your scalp feel the same night?",
    desc: "",
  ...
  },
  {
    id: "styling",
    multiple: 5,
    question: "Over the last year, you have enjoyed: (Please select multiple options if applicable)",
    desc: "",
    options: ["Dyeing your hair", "Bleaching your hair", "Straightening your hair", "Curling your hair", "None of the above"]
  },
  {
    id: "goal",
    multiple: 3,
    question: "Your main hair goals are: (Please select your top 3)",
    desc: "",
    options: ["Daily Maintenance", "Softness And Shine", "Deep Conditioning", "Color Protection", "More Volume", "Oil Control"]
  }
];
